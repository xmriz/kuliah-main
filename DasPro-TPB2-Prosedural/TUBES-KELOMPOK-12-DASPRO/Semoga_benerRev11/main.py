...
def ubah_game(mtrxgametemp,isAdmin):
    ...
    #I.S. tmtrxgametemp, isAdmin terdefinisi
    #F.S. Game berhasil diubah pada mtrxgametemp

    #KAMUS LOKAL
    #mtrxgametemp: array of array of string and integer
    #isAdmin, ada: boolean
    #panjang_matrix: integer
...
# F.S. Data yang sudah diperbarui akan disimpan ke file data.
    ...
    # Deklarasi fungsi/prosedur
    # procedure convert_matrix_to_string (input datas : array of array)
    # I.S. Matriks user terdefinisi; F.S. Matriks user diubah ke bentuk strings sesuai dengan format data csv.
...
# F.S. Data user, game, riwayat, dan kepemilikan tersimpan dalam bentuk file csv dan disimpan di folder sesuai dengan input user.
    ...
    # Deklarasi fungsi/prosedur
    # procedure save_data (input data, filename : string)
    # I.S. Data dan nama file data terdefinisi; F.S. Data yang sudah diperbarui akan disimpan ke file data.
    ...
    while berjalan:
        if notLogin:
            ...
            if perintah.lower() == "login":
                ...
                print("Mohon untuk masuk ke account twaerlebih dahulu!")
