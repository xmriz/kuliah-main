...
\033[93m format input : py program.py -f <nama-folder-csv> \033[0m""")
        return None
    ...
    while berjalan:
        if notLogin:
            ...
            if perintah.lower() == "login":
                ...
                perintah.lower() == "help" or perintah.lower() == "riwayat" or perintah.lower() == "register" or perintah.lower() == "save"):
