...
konkat :: [Char] -> [Char] -> [Char]
   {- fungsi konkat yang menerima masukan 2 buah list of character, misalnya lc1 dan lc2, yang masing-masing mungkin kosong, dan menghasilkan list baru yang merupakan penggabungan lc1 dengan lc2 (lc1 di awal). -}

konkat lc1 lc2
   | isEmpty lc1 = lc2
   | otherwise = konso (head lc1) (konkat (tail lc1) lc2)